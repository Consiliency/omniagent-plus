...
- **Tasks**:
  - test: Add path-entered controls through the real gate orchestration: each
    ...
    and workflow_dispatch use github.sha. No caller-supplied ref/branch/tag is
    ...
    rehearsal and closeout. Test distinct synthetic-merge/head SHAs, rejected
  ...
  - impl: Retain existing dependency/conformance tests. Type-aware lint adds
    ...
    include only SL-0-owned scripts, tests/guard/**, the three owned guard
    helpers and four named process suites via tsconfig.guard.json. No wider
...
END-INPUT-1-GUARD-REVIEW-203e44225a3e40c9996649f07fcc6921

# INPUT-2: plans/evidence/v2/TRIAGE-closeout.json
SHA-256: ddfddc77b68b4aae26b8bc42ef7d2149a8f084cc16426854a53a497ac36d979b

{
  ...
  "amended_candidate_sha256": {
    ...
    "plans/phase-plan-v2-GUARD.md": "1e807d175559146fd661afb7ae772b680a6da9bbf3b5baa7a667f0cae28a8351",
  ...
  "review": {
    ...
    "amendment_panel": "2026-09-14 round 4 preserved: Codex/Grok requested corrections; Gemini affirmative text had a nonconforming terminal line; Fable produced no review. Corrected candidate requires round 5.",
...
END-INPUT-2-GUARD-REVIEW-203e44225a3e40c9996649f07fcc6921
...
END-INPUT-3-GUARD-REVIEW-203e44225a3e40c9996649f07fcc6921

END-BUNDLE-GUARD-REVIEW-203e44225a3e40c9996649f07fcc6921
