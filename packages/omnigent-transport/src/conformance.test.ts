...
describe("official Omnigent v0.10 conformance", () => {
  it("freezes the release authority without broadening neutral capabilities", () => {
    ...
    expect(historicalWire.authority).toEqual(
      expect.objectContaining({
